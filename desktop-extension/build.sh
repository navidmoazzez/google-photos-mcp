...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/google-photos-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/google-photos-$version.mcpb"

echo
echo "Built desktop-extension/google-photos-$version.mcpb"
